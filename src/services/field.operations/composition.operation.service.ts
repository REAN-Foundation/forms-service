...
export class CompositionOperationService {
    ...
    async updateCompositionOperation(id: string, model: CompositionOperationUpdateModel): Promise<CompositionOperationResponseDto> {
        return await this._compositionOperationRepo.updateCompositionOperation(id, model);
    }

    async getCompositionOperationById(id: string): Promise<CompositionOperationResponseDto> {
        return await this._compositionOperationRepo.getCompositionOperationById(id);
    }

    async deleteCompositionOperation(id: string): Promise<boolean> {
        return await this._compositionOperationRepo.deleteCompositionOperation(id);
    }

    async searchCompositionOperation(filters: OperationSearchFilters): Promise<any> {
        return await this._compositionOperationRepo.searchCompositionOperation(filters);
    }
} 