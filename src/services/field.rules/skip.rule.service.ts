...
export class SkipRuleService {
    constructor(
        @inject('ISkipRuleRepo') private _repo: ISkipRuleRepo,
    ) {}

    createSkipRule = async (model: SkipRuleCreateModel): Promise<SkipRuleResponseDto> => {
    ...
    updateSkipRule = async (id: uuid, model: SkipRuleUpdateModel): Promise<SkipRuleResponseDto> => {
    ...
    searchSkipRule = async (filters: RuleSearchFilters): Promise<BaseSearchResults> => {
