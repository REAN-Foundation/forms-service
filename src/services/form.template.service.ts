...
import { ExportFormTemplateDto, FormTemplateCreateModel, FormTemplateSearchFilters, FormTemplateUpdateModel, QuestionDto, SectionDto, SubsectionDto, TemplateDto } from "../domain.types/forms/form.template.domain.types";
...
export class FormTemplateService {
    ...
    //             where: { ParentFormSectionId: section.id, DeletedAt: null }
    //         });
    ...
    //                 where: { ParentFormSectionId: subsection.id, DeletedAt: null }
    //             });
    ...
    readTemplateObjToExport = async (id: uuid): Promise<ExportFormTemplateDto> => {
        ...
        // Step 3: Initialize the Template DTO object
        ...
        for (const section of sections) {
            ...
            // Add the section (with its subsections and questions) to the Template DTO
            templateDto.Sections.push(dtoSection);
        }
    
        // Step 5: Wrap templateDto inside ExportFormTemplateDto and return
        const exportTemplate: ExportFormTemplateDto = {
