...
export interface ILogicRepo {
    ...
    createBaseLogic(model: SkipLogicCreateModel | CalculationLogicCreateModel | ValidationLogicCreateModel): Promise<BaseLogicResponseDto>;
    updateBaseLogic(id: string, model: SkipLogicUpdateModel | CalculationLogicUpdateModel | ValidationLogicUpdateModel): Promise<BaseLogicResponseDto>;
    ...
    createCalculationLogic(model: CalculationLogicCreateModel): Promise<CalculationLogicResponseDto>;
    updateCalculationLogic(id: string, model: CalculationLogicUpdateModel): Promise<CalculationLogicResponseDto>;
    ...
    createValidationLogic(model: ValidationLogicCreateModel): Promise<ValidationLogicResponseDto>;
    updateValidationLogic(id: string, model: ValidationLogicUpdateModel): Promise<ValidationLogicResponseDto>;
