...
export interface IFavoriteTemplateRepo {
    create(model: FavoriteTemplateCreateModel): Promise<FavoriteTemplateResponseDto>;

    update(id: string, model: FavoriteTemplateUpdateModel): Promise<FavoriteTemplateResponseDto>;
