...
export interface ITemplateFolderRepo {
    ...
    create(model: TemplateFolderCreateModel): Promise<TemplateFolderResponseDto>;

    update(id: string, model: TemplateFolderUpdateModel): Promise<TemplateFolderResponseDto>;
