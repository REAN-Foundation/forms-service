...
export interface IResponseRepo{
     ...
     create(model: QuestionResponseCreateModel) : Promise<QuestionResponseResponseDto>;

     save(model: any) : Promise<QuestionResponseResponseDto>;

     update(id: string, model: QuestionResponseUpdateModel) : Promise<QuestionResponseResponseDto>;
