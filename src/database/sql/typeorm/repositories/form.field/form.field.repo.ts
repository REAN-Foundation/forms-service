import { FormFieldCreateModel, FormFieldOption } from "../../../../../domain.types/forms/form.field.domain.types";
...
export class FormFieldRepo extends BaseRepo implements IFormFieldRepo {
  ...
  search = async (filters: FormFieldSearchFilters): Promise<any> => {
    try {
      ...
      const [list, count] = await this._formFieldRepo.findAndCount(search);
