...
import { SkipLogicCreateModel, SkipLogicUpdateModel, LogicSearchFilters } from '../../../domain.types/forms/logic.domain.types';
...
export class SkipLogicController extends BaseController {
    ...
    createSkipLogic = async (request: express.Request, response: express.Response) => {
        try {
            const model: SkipLogicCreateModel = await this._validator.validateSkipLogicCreateRequest(request);
            const record = await this._service.createSkipLogic(model);
            if (record === null) {
                ErrorHandler.throwInternalServerError('Unable to create Skip Logic!', new Error());
            }
    ...
    getSkipLogicById = async (request: express.Request, response: express.Response) => {
        try {
    ...
    updateSkipLogic = async (request: express.Request, response: express.Response) => {
        try {
            const id = await this._validator.validateParamAsUUID(request, 'id');
            const model: SkipLogicUpdateModel = await this._validator.validateSkipLogicUpdateRequest(request);
            const updatedRecord = await this._service.updateSkipLogic(id, model);
    ...
    deleteSkipLogic = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            const id: uuid = await this._validator.validateParamAsUUID(request, 'id');
    ...
    searchSkipLogic = async (request: express.Request, response: express.Response) => {
        try {
