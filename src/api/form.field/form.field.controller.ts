...
export class FormFieldController extends BaseController {
    ...
    create = async (request: express.Request, response: express.Response) => {
        try {
            let model: FormFieldCreateModel = await this._validator.validateCreateRequest(request);
            const parentSectionId = request.body.ParentSectionId;
            const allFormFields = await this._service.search({ parentSectionId });
    ...
    update = async (request: express.Request, response: express.Response) => {
        try {
            ...
            var model: FormFieldUpdateModel = await this._validator.validateUpdateRequest(request);
    ...
    search = async (request: express.Request, response: express.Response) => {
        try {
            var filters: FormFieldSearchFilters = await this._validator.validateSearchRequest(request);
