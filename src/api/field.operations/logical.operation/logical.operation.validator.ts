...
import { LogicalOperatorType, OperationType } from '../../../domain.types/forms/operation.enums';


export class LogicalOperationValidator extends BaseValidator {

    // Logical Operation validation
    public validateLogicalOperationCreateRequest = async (request: express.Request): Promise<LogicalOperationCreateModel> => {
        try {
            const schema = joi.object({
                Name: joi.string().optional(),
                Description: joi.string().optional(),
                Operator: joi.string().valid(...Object.values(LogicalOperatorType)).required(),
    ...
    public validateLogicalOperationUpdateRequest = async (request: express.Request): Promise<LogicalOperationUpdateModel> => {
        try {
            const schema = joi.object({
                Name: joi.string().optional(),
                Description: joi.string().optional(),
